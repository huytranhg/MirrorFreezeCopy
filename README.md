...
***Installation, Uninstallation***
  ...
  Install this Windows Service by using below script (Run as Administrator), with absolute path, where the MirrorFreezeCopy.WindowsService.exe file was saved:
	...
	pause
  Upon installing, Windows will ask for username and password of an acoount, as administrator, you can use any local account having password (as this is Windows's default policy), with a ./ adding before username, like in below screenshot:
